...
public class Cliente extends AutenticacaoAcesso {
	...
	public String toString() {
		return "Cliente [codigoCliente=" + this.codigoCliente + ", Nome=" + this.Nome + ", Cpf=" + this.Cpf + ", Rg="
				+ this.Rg + ", Logradouro=" + this.Logradouro + ", Municipio=" + this.Municipio + ", Uf=" + this.Uf
				+ ", Bairro=" + this.Bairro + ", Numero=" + this.Numero + ", Complemento=" + this.Complemento + ", Cep="
				+ this.Cep + ", Ddd1=" + this.Ddd1 + ", Ddd2=" + this.Ddd2 + ", Telefone1=" + this.Telefone1
				+ ", Telefone2=" + this.Telefone2 + ", Email=" + this.Email + ", senhaCliente=" + this.senhaCliente
				+ ", sexoCliente=" + this.sexoCliente + ", DataNascimento=" + this.DataNascimento + ", Pessoa="
				+ this.Pessoa + ", RazaoSocial=" + this.RazaoSocial + ", Cnpj=" + this.Cnpj + ", InscricaoEstadual="
				+ this.InscricaoEstadual + ", paisCliente=" + this.paisCliente + ", codigoPaisCliente="
				+ this.codigoPaisCliente + ", codigoMunicipioCliente=" + this.codigoMunicipioCliente
				+ ", dataUltimaCompraCliente=" + this.dataUltimaCompraCliente + ", InformacoesReferencia="
				+ this.InformacoesReferencia + "]";
	}
}