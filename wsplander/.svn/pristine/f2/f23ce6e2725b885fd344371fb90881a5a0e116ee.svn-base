...
public class WS {
    ...
    public Response novologin(Pedido p) {
        ...
        try {
            retornoCliente = ls.loginCliente(p.getFkCliente().getEmail().toLowerCase(), p.getFkCliente().getSenhaCliente());
        }
        ...
        if (retornoCliente.getCodStatus() == 1) {
            ...
            p.getFkCliente().setInformacoesReferencia(((Cliente)retornoCliente.getModel()).getInformacoesReferencia());
            ...
            try {
                ...
                ((Pedido)retornoPedido.getModel()).setCodigoPedido(ps.getPedidoForId(((Pedido)retornoPedido.getModel()).getCodigoPedido()));
    ...
    public Response novopedido(Pedido p) {
        ...
        try {
            ...
            ((Pedido)retorno.getModel()).setCodigoPedido(ps.getPedidoForId(((Pedido)retorno.getModel()).getCodigoPedido()));
            ps.CloseConnection();
            System.out.println((Object)retorno);
            return Response.ok((Object)retorno).build();
        }
